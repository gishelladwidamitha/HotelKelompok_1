        ...
        <div class="col-md-5" data-aos="fade-up" data-aos-delay="200">
          <div class="row">
            <div class="col-md-10 ml-auto contact-info">
              <p><span style="font-size: 30px;" class="d-block"><strong>ALAMAT</strong>:</span> <span style="font-size: 35px;" class="text-black"> Jl. Raya Tugu Depok, Depok, 12345</span></p>
              <p><span style="font-size: 30px;" class="d-block"><strong>TELEPON</strong>:</span> <span style="font-size: 35px;" class="text-black"> (021) 3456789</span></p>
              <p><span style="font-size: 30px;" class="d-block"><strong>EMAIL</strong>:</span> <span style="font-size: 35px;" class="text-black"> admin@mercuredepok.id</span></p>
            </div>
          </div>
        </div>
      </div>
